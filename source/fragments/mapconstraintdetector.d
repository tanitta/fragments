...
private struct AABBNode(NumericType){
    ...
    public{
        ...
        this(StaticEntity!(N)[] staticEntities)in{assert( staticEntities.length > 0, "empty entities");}body{
            ...
            Vector!(N, 3) start = staticEntities[0].boundingBox.start;
            Vector!(N, 3) end = staticEntities[0].boundingBox.end;
...
private void drawBoundingBox(B)(B boundingBox){
    with( boundingBox ){
        import armos.graphics;
        drawLine(start[0], start[1], start[2], end[0], start[1], start[2]);
        drawLine(start[0], start[1], start[2], start[0], end[1], start[2]);
        drawLine(start[0], start[1], start[2], start[0], start[1], end[2]);

        drawLine(start[0], end[1], start[2], end[0], end[1], start[2]);
        drawLine(start[0], end[1], start[2], start[0], end[1], end[2]);

        drawLine(end[0], end[1], end[2], start[0], end[1], end[2]);
        drawLine(end[0], end[1], end[2], end[0], start[1], end[2]);
        drawLine(end[0], end[1], end[2], end[0], end[1], start[2]);

        drawLine(end[0], start[1], end[2], start[0], start[1], end[2]);
        drawLine(end[0], start[1], end[2], end[0], start[1], start[2]);
        
        drawLine(start[0], end[1], end[2], start[0], start[1], end[2]);
        drawLine(end[0], end[1], start[2], end[0], start[1], start[2]);
    }
}
...
private int majorAxis(Numeric)(in BoundingBox!(Numeric) boundingbox){
    ...
    return ( reduce!(fmax)(vec.elements).among(vec[0], vec[1], vec[2])-1 );
}
unittest{
    alias V = Vector3d;
