...
private N jacDiagInv(N, V3 = Vector!(N, 3), M33 = Matrix!(N, 3, 3))(
    in V3 applicationPoint,
    in N massInv,
...
private M33 massAndInertiaTermInv(N, V3 = Vector!(N, 3), M33 = Matrix!(N, 3, 3))(
    in V3 applicationPoint,
    in N massInv,
    in M33 inertiaGlobalInv, 
){
...
private M33 crossMatrix(V3, M33 = Matrix!(typeof(V3[0]), 3, 3))(in V3 vector){
    return M33(
        [ 0,          -vector[2], vector[1]  ],
        [ vector[2],  0,          -vector[0] ],
        [ -vector[1], vector[0],  0          ],
